...
function List({ comeInTime, comeOutTime, breakStrTime, breakFinTime }) {
  return (
    <table className=" border-[1px] border-solid  flex justify-center md:ml-[3%]">
      <tbody>
        ...
        <tr>
          <td className=" border-[1px] border-solid p-1 max-[523px]:text-[10px]">
            今日の日付
          </td>
          <td
            className=" border-[1px] border-solid p-1  max-[523px]:text-[10px]"
            colSpan={2}
          >
            <AtBtn />
          </td>
