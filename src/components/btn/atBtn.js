...
const [state, setState] = useState(true);
    ...
    return (
        <div className=' flex'>
            <button variant="contained" onClick={comeBtn} disabled={!state} className='text-xl mt-10 mr-10 border-b-[5px] bg-[#b8fc6f] hover:text-[#000] hover:bg-[#c5fd88] hover:border-b-2 hover:border-solid hover:border-[#7ec731] hover:translate-y-px  custom-button ml-2'>出勤</button> 
